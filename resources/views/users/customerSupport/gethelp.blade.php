...
<main>
    <div>
        <a href="{{ url('chat/chat.html') }}" class="d-flex align-items-start">
    ...
    <div>
        <a href="mailto:{{ $settings->email }}" class="d-flex align-items-start">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                xmlns="http://www.w3.org/2000/svg">
    ...
    <div>
        <a href="tel:{{ $settings->phone }}" class="d-flex align-items-start">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                xmlns="http://www.w3.org/2000/svg">
