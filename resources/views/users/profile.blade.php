  ...
  <div class="list-group">
    ...
    <a href="#" class="list-group-item d-flex align-items-center justify-content-between mb-3 menu-item">
      <div class="d-flex align-items-center">
        ...
        <div><span class="menu-title">Transactions</span><br><small class="menu-sub">See all transactions</small></div>
    ...
    <a href="#" class="list-group-item d-flex align-items-center justify-content-between mb-3 menu-item">
      <div class="d-flex align-items-center">
        ...
        <div><span class="menu-title">My Orders</span><br><small class="menu-sub">View order history</small></div>
      </div><i class="fas fa-chevron-right arrow"></i>
    </a>
    ...
    <a href="#" class="list-group-item d-flex align-items-center justify-content-between mb-3 menu-item">
      <div class="d-flex align-items-center">
        ...
        <div><span class="menu-title">My Reviews</span><br><small class="menu-sub">View your reviews</small></div>
      </div><i class="fas fa-chevron-right arrow"></i>
    </a>
    ...
    <a href="#" class="list-group-item d-flex align-items-center justify-content-between mb-3 menu-item">
      <div class="d-flex align-items-center">
        ...
        <div><span class="menu-title">Preferences</span><br><small class="menu-sub">Notification settings</small></div>
      </div><i class="fas fa-chevron-right arrow"></i>
    </a>
    ...
    <a href="#" class="list-group-item d-flex align-items-center justify-content-between mb-3 menu-item">
      <div class="d-flex align-items-center">
        ...
        <div><span class="menu-title">Help & Support</span><br><small class="menu-sub">Customer support</small></div>
      </div><i class="fas fa-chevron-right arrow"></i>
    </a>
...
<div class="container text-center mt-4 mb-4">
  <a href="{{ route('user_logout') }}" id="logout" class="logout-btn d-block w-100 text-white">Logout</a>
</div>
