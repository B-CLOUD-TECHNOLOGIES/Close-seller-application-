  ...
  <div class="top-bar">
    <div class="d-flex justify-content-between align-items-center">
      <div class="d-flex align-items-center gap-2">
       <a class="arrow-back-a" href="{{ route('user.dashboard') }}">
  ...
  <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            async function fetchTransactions(startDate = '', endDate = '') {
                try {
                    const response = await fetch(`/users/fetch-transactions?startDate=${startDate}&endDate=${endDate}`);
            ...
            function renderTransactions(list) {
                ...
                document.querySelectorAll('.view-details-btn').forEach(btn => {
                    btn.addEventListener('click', (e) => {
                        ...
                        window.location.href = `/users/transactions/${orderId}`;
                    });
                });
            }
