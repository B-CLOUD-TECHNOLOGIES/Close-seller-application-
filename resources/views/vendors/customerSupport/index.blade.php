...
<div class="header">
  ...
  <div class="support-container" style="margin-bottom: 150px;">
    <div class="support-section">
      <a href="{{ route('vendor.sendFeedback') }}" class="support-item">
      ...
      <a href="{{ route('vendor.faqs') }}" class="support-item">
        <div class="support-icon">
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href="{{ route ('vendor.gethelp') }}" class="support-item">
        <div class="support-icon">
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href="{{ route('vendor.sendReport') }}" class="support-item">
        <div class="support-icon">
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
