...
<link rel="stylesheet" href="{{ asset('vendors/assets/css/changePassword.css') }}" />
 ...
 <div class="container d-flex align-items-center justify-content-center min-vh-100">
      <div class="card shadow border-0 p-4 custom-card">
        <!-- Back -->
        <a href="{{ route('vendor.settings') }}" id="backBtn" class="mb-3 text-decoration-none back-link">
        ...
        <form id="passwordForm">
          ...
          <button
            type="submit"
            class="btn w-100 text-white fw-bold py-2 save-btn"
          >
    ...
    <script>
        ...
        form.addEventListener("submit", async (e) => {
            ...
            try {
            const res = await fetch(`{{ route('vendor.update.password') }}`, {
                method: "POST",
                headers: {
